...
export function Pools({ colors, focus }: { colors: string[]; focus?: number | null }) {
  ...
  const pool = "absolute aspect-square rounded-full bg-(--c) opacity-(--pool-opacity) blur-[46px] transition-[transform,opacity] duration-900 ease-out animate-[drift_38s_ease-in-out_infinite_alternate] motion-reduce:animate-none";
  return (
