/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cfb0cf851ba7b6845f6732bd7b5ff658)
// Runtime types generated with workerd@1.20260918.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ENVIRONMENT: "production" | "development";
	APP_URL: "https://logru.example.com" | "http://localhost:5173";
	MAIL_FROM: "Logru <no-reply@example.com>";
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		APP_URL: "https://logru.example.com";
		MAIL_FROM: "Logru <no-reply@example.com>";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APP_URL" | "MAIL_FROM">> {}
}
