...
/**
 * 記録に付かないまま、この時間がたった写真を消す。1 時間。
 * 写真は選んだそばから送るので、シートを閉じたときや写真を外したときに、その場で消す API が先に片付ける。
 * これは、それでも残った孤児を拾う安全網。0021、#158
 */
 ...
 *
 * 1. 記録に付かないまま 1 時間たった写真の行を消す。トリガーが R2 の鍵を積む
